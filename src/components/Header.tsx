...
const Menu = () => {
  ...
  return (
    <>
      <svg
        className={`hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-yellow-300 transform translate-x-1/2`}
        fill="currentColor"
        viewBox="0 0 100 100"
            ...
            <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div className="flex items-center justify-between w-full md:w-auto">
                <a href="#">
                  ...
                  <img alt="logo" className="h-13 w-auto sm:h-16" src={logo} />
                </a>
